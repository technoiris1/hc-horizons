	...
	<div class="flex flex-col items-center gap-[25px] w-[1008px] max-w-full mx-auto mt-12">
		...
		<div class="flex gap-6 items-start w-full">
			...
			<div class="flex flex-col gap-6 w-[635px] shrink-0">
				...
				<a href="/app/projects" class="card relative block h-[276px] w-full bg-[#F3E8D8]" class:selected={nav.isSelected(0, 0)} style:background-color={nav.isSelected(0, 0) ? '#ffa936' : ''} onmouseenter={() => nav.select(0, 0)} onclick={(e) => { e.preventDefault(); navigateTo('/app/projects'); }}>
